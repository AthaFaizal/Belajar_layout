...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget textSection = Container(
      ...
      child: const Text(
        'Gunung Ijen adalah sebuah gunung berapi  '
            'yang terletak di perbatasan Kabupaten Banyuwangi dan Kabupaten Bondowoso, Jawa Timur, Indonesia. '
            'Gunung ini memiliki ketinggian 2.386 mdpl.  '
            'Gunung Ijen terakhir meletus pada tahun 1999. '
            'Salah satu fenomena alam yang paling terkenal dari Gunung Ijen adalah blue fire. '
            'Athallarik Faizal 362358302070 🙂.',
